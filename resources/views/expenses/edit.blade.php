...
@if(session('success'))
            ...
            @endif
              <div class="card-header">
                ...
                <form action="{{route('expenses.update',$expense->e_id)}}" method="post" enctype="multipart/form-data">
              @csrf
              @method("PATCH")
                ...
                <div class="card-body">
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <select  class="form-control" name="head" required>
                      <option value="{{$expense->head_id}}" >{{$expense->expense_head}}</option>
                      @if(count($heads) > 0)
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" name="remarks" value="{{$expense->remarks}}" >
                  </div>                 
                  </div>
